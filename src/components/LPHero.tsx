    ...
    <>
      <style jsx>{`
        @keyframes button-glow {
          0% {
            box-shadow: 0 4px 6px -1px rgba(1, 8, 195, 0.1), 0 2px 4px -1px rgba(1, 8, 195, 0.06);
            transform: translateY(0) scale(1);
          }
          50% {
            box-shadow: 0 20px 25px -5px rgba(1, 8, 195, 0.3), 0 10px 10px -5px rgba(1, 8, 195, 0.2);
            transform: translateY(-2px) scale(1.05);
          }
          100% {
            box-shadow: 0 10px 15px -3px rgba(1, 8, 195, 0.2), 0 4px 6px -2px rgba(1, 8, 195, 0.1);
            transform: translateY(0) scale(1);
          }
        }
      ...
      <section className="bg-white md:bg-gradient-to-br md:from-blue-50 md:to-white py-20 lg:py-24 mt-2 md:mt-0">
