      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Weitere Informationen zum Datenschutz finden Sie in unserer <Link href="/datenschutz" className="text-blue-600 hover:text-blue-800 underline">Datenschutzerklärung</Link>.
            </p>
          </section>
